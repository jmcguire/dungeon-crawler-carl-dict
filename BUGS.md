...
Entries that aren't good:
 ...
 - Veeka, we got the "it's a stub" message, but not the actual description below it.
 - Fan Art for System AI, this is a fan art page, we should exclude it. but also, no one will ever encounter this entry anyways, so it might be more bother than it's worth to handle it.
 - Commander Stockade
